...
use Zoop\Mystique\GreaterThanEqual;

class GreaterThanEquallTest extends \PHPUnit_Framework_TestCase {

    public function testValidator(){

        $testData = json_decode(file_get_contents(__DIR__ . '/../../../../../common/testdata/greaterThanEqual.json'), true);
        ...
        foreach ($testData['data'] as $testPoint){
            ...
            $validator = new GreaterThanEqual($testPoint['options']);
