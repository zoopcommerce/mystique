...
use Zoop\Mystique\GreaterThan;

class GreaterThanTest extends \PHPUnit_Framework_TestCase {

    public function testValidator(){

        $testData = json_decode(file_get_contents(__DIR__ . '/../../../../../common/testdata/greaterThan.json'), true);
        ...
        foreach ($testData['data'] as $testPoint){
            ...
            $validator = new GreaterThan($testPoint['options']);
