...
use Zoop\Mystique\NotEqual;

class NotEquallTest extends \PHPUnit_Framework_TestCase {

    public function testValidator(){

        $testData = json_decode(file_get_contents(__DIR__ . '/../../../../../common/testdata/notEqual.json'), true);
        ...
        foreach ($testData['data'] as $testPoint){
            ...
            $validator = new NotEqual($testPoint['options']);
