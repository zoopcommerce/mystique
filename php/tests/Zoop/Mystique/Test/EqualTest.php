...
use Zoop\Mystique\Equal;

class EquallTest extends \PHPUnit_Framework_TestCase {

    public function testValidator(){

        $testData = json_decode(file_get_contents(__DIR__ . '/../../../../../common/testdata/equal.json'), true);
        ...
        foreach ($testData['data'] as $testPoint){
            ...
            $validator = new Equal($testPoint['options']);
