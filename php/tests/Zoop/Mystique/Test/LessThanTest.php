...
use Zoop\Mystique\LessThan;

class LessThanlTest extends \PHPUnit_Framework_TestCase {

    public function testValidator(){

        $testData = json_decode(file_get_contents(__DIR__ . '/../../../../../common/testdata/lessThan.json'), true);
        ...
        foreach ($testData['data'] as $testPoint){
            ...
            $validator = new LessThan($testPoint['options']);
